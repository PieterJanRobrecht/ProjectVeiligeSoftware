...
public class Client {
	...
	private static final byte LENGTH_CERT_INS = 0x30;
	private static final byte SNED_CERT_INS = 0x32;
...
//			
//			//3. Send other
//			a = new CommandAPDU(IDENTITY_CARD_CLA, GET_SERIAL_INS, 0x00, 0x00, 0xff);
//			r = c.transmit(a);
//			// simulator gaat wat brol meesturen "80240000003"
//
...
//			System.out.println("Het is gelukt?");
			...
			System.out.println("Time to sign something");
			...
			System.out.println("Asking for CERT LENGTH");
			a = new CommandAPDU(IDENTITY_CARD_CLA, LENGTH_CERT_INS, 0x00, 0x00, 0xff);
			r = c.transmit(a);

			System.out.println("Received data");
			System.out.println(new BigInteger(1,r.getData()).toString(16));
			System.out.println(new BigInteger(1,r.getData()).intValue());
			// Lengte opdelen in blokken van 240 groot en zoveel commando's voor cert op te vragen
